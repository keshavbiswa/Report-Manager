...
namespace NEDRC.Controllers
{
    ...
    public class ManageController : Controller
    {
        ...
        public async Task<ActionResult> AddPhoneNumber(AddPhoneNumberViewModel model)
        {
            ...
            Users.PhoneNumber = model.Number;
            db.SaveChanges();
            return RedirectToAction("SuccessPhoneNumber", new { PhoneNumber = model.Number });
        }
        ...
        public async Task<ActionResult> SuccessPhoneNumber(string phoneNumber)
        {
